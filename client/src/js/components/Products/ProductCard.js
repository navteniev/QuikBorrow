...
const ProductCard = props => {
  const { id, name, user, description, availability, productImage } = props;
  const history = useHistory()

  return (
    <FlexCard>
      <FlexCardImage image={productImage || 'https://patch.com/img/cdn/users/1142384/2013/09/raw/77d3e8242e7562885116ebff68689271.jpg'} title='image' />
      <FlexCardContent>
        <div>
          <SpaceBetween>
